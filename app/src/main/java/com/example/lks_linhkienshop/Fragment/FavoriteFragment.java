...
public class FavoriteFragment extends Fragment {
    ...
    public List<SanPham> initDataProduct() {
        ...
        itemListSanPham.add(new SanPham(1,1,2,"asdad","CPU Intel Celeron G5905",1390000,"hahah",false));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","RAM Desktop Kingmax 4GB DDR4 Bus 2666MHz",524825,"hahah",true));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","Ổ cứng HDD 2TB Seagate SkyHawk ST2000VX008",1440000,"hahah",false));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","Ổ cứng SSD 256GB ADATA SX6000 (ASX6000LNP-256GT-C)",1090000,"hahah",false));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","VGA ASUS DUAL-RTX2060S-O8G-EVO-V2",550000,"hahah",false));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","Sound card NEWMB N-EXPS8738",40000,"hahah",true));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","VGA ASUS DUAL-RTX2060S-O8G-EVO-V2",370000,"hahah",true));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","Case Jetek Rhino Art - G9323",500000,"hahah",false));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","Nguồn Arrow 625W",440000,"hahah",true));
        itemListSanPham.add(new SanPham(1,1,2,"asdad","DVDRW Transcend TS8XDVDS-K",750000,"hahah",true));
